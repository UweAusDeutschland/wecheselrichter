# batterymonitor.py — Refactored battery monitor using monitor_base module
import os
import time
...
cleanup_old_csv_files(base_dir="data", prefix="battery_", retention_days=RETENTION_DAYS)
...
last_battery = None
interval = 5.0  # Alle 5 Sekunden auslesen (Batteriestand ändert sich weniger häufig)
next_call = time.time()
...
try:
    while True:
        try:
            ...
            print("Warning: reading battery level failed:", type(e).__name__, e)
            time.sleep(1)
            continue
